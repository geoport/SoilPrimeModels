...
from soilprime_models import SoilLayer, SPTExp
...
class LiquefactionResult(BaseModel):
    spt_seed_idriss: Optional[SptLiquefactionResult] = None
    vs_andrus_stokoe: Optional[VSLiquefactionResult] = None
    is_safe: bool = False
